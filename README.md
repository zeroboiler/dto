...
|||[![Tests: 258](https://img.shields.io/badge/Tests-258-brightgreen)]()|
||||[![Version 1.1.20](https://img.shields.io/badge/Version-1.1.20-green)](https://github.com/zeroboiler/dto/releases)|
...
|- 258 test files in `tests/` (41 fixtures)
...
The test suite includes **255 test files** (255 unit tests + 41 fixtures) covering:
