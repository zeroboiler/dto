...
| [![Tests: 316 files](https://img.shields.io/badge/Tests-316%20files-brightgreen)](tests)|
...
| - 316 test files in `tests/` (42 fixtures) |
...
The test suite includes **316 test files** covering:
