...
||[![Tests: 295](https://img.shields.io/badge/Tests-295-brightgreen)]()|
||[![Version 1.1.18](https://img.shields.io/badge/Version-1.1.18-green)](https://github.com/zeroboiler/dto/releases)|
...
|- 295 test files in `tests/` (41 fixtures)
...
The test suite includes **250 test files** (250 unit tests + 41 fixtures) covering:
