...
| [![Tests: 361 files](https://img.shields.io/badge/Tests-361%20files-brightgreen)](tests)|
...
| - 361 test files in `tests/` (42 fixtures) |
...
The test suite includes **361 test files** covering:
