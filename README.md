...
[![Tests: 371 files](https://img.shields.io/badge/Tests-371%20files-brightgreen)](tests)
[![Version 1.1.75](https://img.shields.io/badge/Version-1.1.75-green)](https://github.com/zeroboiler/dto/releases)
...
| - 371 test files in `tests/` (42 fixtures) |
...
The test suite includes **363 test files** covering:
...
- **Docs**: Fix README test count badge (331→290), package statistics accurate
- **Quality**: Full source code audit — strict types, return types, docblocks, PHPStan L9 compliance verified across all 55 source files
