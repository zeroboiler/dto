...
|||[![Tests: 259](https://img.shields.io/badge/Tests-259-brightgreen)]()|
||||[![Version 1.1.21](https://img.shields.io/badge/Version-1.1.21-green)](https://github.com/zeroboiler/dto/releases)|
...
|- 259 test files in `tests/` (41 fixtures)
...
The test suite includes **256 test files** (256 unit tests + 41 fixtures) covering:
