...
|[![Tests: 226](https://img.shields.io/badge/Tests-226-brightgreen)]()
...
|- 226 test files in `tests/` (33 fixtures)
...
The test suite includes **226 test files** (226 unit tests + 33 fixtures) covering:
