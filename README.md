...
| [![Tests: 360 files](https://img.shields.io/badge/Tests-360%20files-brightgreen)](tests)|
...
| - 360 test files in `tests/` (42 fixtures) |
...
The test suite includes **360 test files** covering:
