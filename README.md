...
|[![Tests: 270](https://img.shields.io/badge/Tests-270-brightgreen)]()
|[![Version 1.1.28](https://img.shields.io/badge/Version-1.1.28-green)](https://github.com/zeroboiler/dto/releases)
...
|- 270 test files in `tests/` (41 fixtures)
...
The test suite includes **262 test files** (260 unit tests + Pest.php + bootstrap.php) covering:
