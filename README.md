...
| [![Tests: 362 files](https://img.shields.io/badge/Tests-362%20files-brightgreen)](tests)|
| [![Version 1.1.72](https://img.shields.io/badge/Version-1.1.72-green)](https://github.com/zeroboiler/dto/releases) |
...
| - 362 test files in `tests/` (42 fixtures) |
...
The test suite includes **362 test files** covering:
